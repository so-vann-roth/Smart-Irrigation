...
void loop() {
  ...
  if (XBee.available() > 0)
  {
    ...
    */
    ...
    String getData = "GET /update?api_key="+ API +"&field1="+String(temp1)+"&field2="+String(hum1)+"&field3="+String(mois1)+"&field4="+String(temp2)+"&field5="+String(hum2)+"&field6="+String(mois2)+"&field7="+String(rad1);
